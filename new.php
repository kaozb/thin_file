...
$root_path = $_SERVER['DOCUMENT_ROOT'].$the_path;;
...
$external = array(
    'css-bootstrap' => '<link href="/loacl/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">',
    'css-dropzone' => '<link href="/loacl/dropzone.min.css" rel="stylesheet">',
    'css-font-awesome' => '<link rel="stylesheet" href="/loacl/font-awesome.min.css" crossorigin="anonymous">',
    'css-highlightjs' => '<link rel="stylesheet" href="/loacl/vs.min.css">',
    'js-ace' => '<script src="/loacl/ace.js"></script>',
    'js-bootstrap' => '<script src="/loacl/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>',
    'js-dropzone' => '<script src="/loacl/dropzone.min.js"></script>',
    'js-jquery' => '<script src="/loacl/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>',
    'js-jquery-datatables' => '<script src="/loacl/jquery.dataTables.min.js" crossorigin="anonymous" defer></script>',
    'js-highlightjs' => '<script src="/loacl/highlight.min.js"></script>',
...
defined('FM_ROOT_URL2') || define('FM_ROOT_URL2', ($is_https ? 'https' : 'http') . '://' . $http_host . $the_path );
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                        ...
                        <?php endif; ?>
                        <a title="<?php echo lng('DirectLink')?>" href="<?php echo fm_enc(FM_ROOT_URL2 . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f . '/') ?>" target="_blank"><i class="fa fa-link" aria-hidden="true"></i></a>
                    </td>
                </tr>
                <?php
                flush();
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td data-sort=<?php echo fm_enc($f) ?>>
                        ...
                        <?php
                           if (in_array(strtolower(pathinfo($f, PATHINFO_EXTENSION)), array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))): ?>
                                <?php $imagePreview = fm_enc(FM_ROOT_URL2 . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f); ?>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php endif; ?>
                        <a title="<?php echo lng('DirectLink') ?>" href="<?php echo fm_enc(FM_ROOT_URL2 . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" target="_blank"><i class="fa fa-link"></i></a>
...
function lng($txt) {
	...
	$tr['en']['CalculateFolderSize']        = '显示文件夹大小';
	$tr['en']['FullSize']        = '所有文件大小';
	$tr['en']['MemoryUsed']        = '使用内存';
	$tr['en']['PartitionSize']        = '可用空间';
	$tr['en']['FreeOf']        = '磁盘大小';
	$tr['en']['Check Latest Version']        = '检查更新';
	...
	$tr['en']['Deleted']        = '删除';
	$tr['en']['not deleted']        = '未删除';
	$tr['en']['Invalid file or folder name']        = '无效的文件或文件夹名';
	$tr['en']['Created']        = '已创建';
	$tr['en']['File extension is not allowed']        = '不允许文件扩展名';
	$tr['en']['already exists']        = '已经存在';
	$tr['en']['not created']        = '未创建';
	$tr['en']['Invalid characters in file or folder name']        = '文件或文件夹名称中的无效字符';
	$tr['en']['Source path not defined']        = '未定义源路径';
	$tr['en']['Moved from']        = '移动自';
	$tr['en']['to']        = '至';
	$tr['en']['File or folder with this path already exists']        = '具有此路径的文件或文件夹已存在';
	$tr['en']['Error while moving from']        = '移动时出错';
	$tr['en']['Copied from']        = '复制自';
	$tr['en']['Error while copying from']        = '复制时出错';
	$tr['en']['Paths must be not equal']        = '路径必须不相等';
	$tr['en']['Nothing selected']        = '未选择任何内容';
	$tr['en']['Error while renaming from']        = '重命名时出错';
	$tr['en']['Invalid characters in file name']        = '文件名中的无效字符';
	$tr['en']['Invalid Token.']        = '无效令牌。';
	$tr['en']['Selected files and folder deleted']        = '已删除选定的文件和文件夹';
	$tr['en']['Error while deleting items']        = '删除项目时出错';
	$tr['en']['Operations with archives are not available']        = '存档操作不可用';
	$tr['en']['Archive']        = '存档';
	$tr['en']['Archive not created']        = '未创建存档';
	$tr['en']['Archive unpacked']        = '存档未打包';
	$tr['en']['Archive not unpacked']        = '存档未打开';
	$tr['en']['Permissions changed']        = '权限已更改';
	$tr['en']['Permissions not changed']        = '权限未更改';
	$tr['en']['Select folder']        = '选择文件夹';
	$tr['en']['Theme']        = '主题';
	$tr['en']['light']        = '浅色';
	$tr['en']['dark']        = '深色';
	$tr['en']['Error while fetching archive info']        = '获取存档信息时出错';
	$tr['en']['File Saved Successfully']        = '文件保存成功';
	$tr['en']['FILE EXTENSION HAS NOT SUPPORTED']        = '文件扩展名不受支持';
	$tr['en']['Folder is empty']        = '文件夹为空';
	$tr['en']['Delete selected files and folders?']        = '是否删除选定的文件和文件夹？';
	$tr['en']['Create archive?']        = '创建存档？';
	$tr['en']['Zip']        = 'Zip';
	$tr['en']['Tar']        = 'Tar';
	$tr['en']['Zero byte file! Aborting download']        = '零字节文件！正在中止下载';
	$tr['en']['Cannot open file! Aborting download']        = '无法打开文件！正在中止下载';
	$tr['en']['Filter']        = '过滤器';
	$tr['en']['Advanced Search']        = '高级搜索';
	$tr['en']['Search file in folder and subfolders...']        = '在文件夹和子文件夹中搜索文件…';
	$tr['en']['Are you sure want to']        = '你确定要';
	$tr['en']['Okay']        = '确定';
	$tr['en']['a files']        = '一个文件';
	$tr['en']['Enter here...']        = '在此处输入...';
	$tr['en']['Enter new file name']        = '输入新文件名';
	$tr['en']['Full path']        = '完整路径';
	$tr['en']['File size']        = '文件大小';
	$tr['en']['MIME-type']        = 'MIME类型';
	$tr['en']['Image sizes']        = '图像大小';
	$tr['en']['Charset']        = '编码格式';
	$tr['en']['Image']        = '图片';
	$tr['en']['Audio']        = '音频';
	$tr['en']['Video']        = '视频';
	$tr['en']['Upload from URL']        = '从URL上传';
	$tr['en']['Files in archive']        = '档案文件';
	$tr['en']['Total size']        = '总大小';
	$tr['en']['Compression']        = '压缩';
	$tr['en']['Size in archive']        = '存档中的大小';
	$tr['en']['Fullscreen']        = '全屏';
	$tr['en']['Word Wrap']        = '自动换行';
	$tr['en']['Undo']        = '撤消';
	$tr['en']['Redo']        = '恢复';
	$tr['en']['Select Document Type']        = '选择文档类型';
	$tr['en']['Select Mode']        = '选择模式';
	$tr['en']['Select Theme']        = '选择主题';
	$tr['en']['Select Font Size']        = '选择字体大小';
	$tr['en']['Are you sure want to rename?']        = '是否确实要重命名?';
